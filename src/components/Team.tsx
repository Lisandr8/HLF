      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {LAWYERS.map((lawyer, idx) => (
            ...
            >
              ...
              <p className="text-stone-400 text-sm leading-relaxed line-clamp-2 italic">
                "{lawyer.bio}"
              </p>
            </motion.div>
          ))}
        ...
        <div className="mt-20 p-12 bg-stone-50 rounded-3xl border border-stone-100 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="max-w-xl">
            ...
            <p className="text-stone-500">Contamos con una red extendida de consultores en diversas jurisdicciones internacionales.</p>
          </div>
