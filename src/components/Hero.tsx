...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute top-1/4 -right-20 w-96 h-96 bg-stone-200/50 rounded-full blur-3xl -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <span className="inline-block px-4 py-1.5 bg-stone-900 text-white text-xs font-bold tracking-widest uppercase rounded-full mb-8">
            Establecidos en 1998
          </span>
          <h1 className="text-6xl md:text-8xl font-serif leading-[0.9] mb-8">
            Justicia <br />
            <span className="italic text-stone-400">con</span> Claridad.
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <a 
              href="#consultar"
              className="bg-stone-900 text-white px-8 py-4 rounded-full font-medium hover:bg-stone-800 transition-all flex items-center gap-2 group"
            >
            ...
            <a 
              href="#servicios"
              className="px-8 py-4 rounded-full font-medium border border-stone-300 hover:border-stone-900 transition-all"
            >
              Nuestros Servicios
            </a>
          </div>
        ...
        >
          ...
          {/* Floating card */}
          <div className="absolute -bottom-10 -left-10 bg-white p-6 rounded-2xl shadow-xl border border-stone-100 max-w-xs">
            <p className="text-stone-900 font-serif italic text-lg mb-2">"La integridad es la base de cada victoria legal."</p>
            <p className="text-stone-400 text-xs uppercase tracking-widest font-bold">— Dr. Alejandro Lex, Socio Fundador</p>
          </div>
        </motion.div>
      </div>
    </section>
