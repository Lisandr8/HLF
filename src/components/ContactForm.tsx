...
export default function ContactForm() {
  ...
  return (
    <section id="contacto" className="bg-stone-900 py-24 border-b border-stone-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-4xl md:text-5xl font-serif text-white mb-6">Inicie su Consulta</h2>
          ...
          <div className="bg-stone-800/50 p-8 md:p-10 rounded-3xl border border-stone-700 shadow-2xl relative overflow-hidden">
            <AnimatePresence mode="wait">
              {status === 'success' ? (
                ...
                >
                  ...
                  <h3 className="text-2xl font-serif text-white mb-4">Mensaje Enviado</h3>
                  ...
                  <button 
                    ...
                    className="mt-8 text-stone-400 hover:text-white text-sm underline underline-offset-4"
                  >
                    Enviar otro mensaje
                  </button>
                </motion.div>
                ...
                >
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-stone-900 border border-stone-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-stone-500 outline-none transition-all"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <select 
                      ...
                      onChange={handleChange}
                      className="w-full bg-stone-900 border border-stone-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-stone-500 outline-none transition-all appearance-none"
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-stone-900 border border-stone-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-stone-500 outline-none transition-all resize-none"
                    />
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full bg-white text-stone-900 py-4 rounded-xl font-bold hover:bg-stone-200 transition-all flex items-center justify-center gap-2 group disabled:opacity-50"
                  >
                    {status === 'loading' ? (
